...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 23 okt 2017 om 21:22
...
(20, 2, 2, 0, 'een hele hoop denk ik.', '22-10-2017');
...
INSERT INTO `students` (`name`, `ov_number`, `admin`, `klas`, `wachtwoord`, `cohort_id`, `profile_img`) VALUES
('Fenno', 99034050, 0, 'lpiaoa2', '123', 1, 'user1-128x1281.jpg'),
('Docent', 99034056, 1, 'lpiaoa1', '123', 1, 'user1-128x1281.jpg');
...
INSERT INTO `subject_done` (`id`, `subject_id`, `done`, `ov_number`, `name`, `Comment`, `edited_by`) VALUES
(1, 1, 'Yes', 99035055, 'Furkan', '', ''),
(20, 2, 'Yes', NULL, 'Fenno', 'hallo dit is een test comment voor ji', 'Fenno');
...
--
ALTER TABLE `subject_done`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=532;COMMIT;
